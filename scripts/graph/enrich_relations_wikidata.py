...
def write_relations(path: str, rows: List[Dict[str, str]]) -> None:
    os.makedirs(os.path.dirname(path) or ".", exist_ok=True)
    fieldnames = ["start_id", "relation", "end_id", "year", "role", "source", "confidence"]
...
def merge_relations(
    ...
    new_edges: Iterable[Tuple[str, str, str]],
    source: str,
    confidence: str,
) -> List[Dict[str, str]]:
...
def main() -> None:
    ...
    write_relations(args.out, merged)
